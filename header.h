...
typedef struct variable {
    ...
    bool used; // true se la variabile viene usata
...
typedef struct error {
    bool wrong_type; // true se il tipo è errato
    bool wrong_name; // true se il nome è errato
    int row; // numero di riga dove si trova l'errore
    struct error *next; // puntatore al prossimo errore
} error;
